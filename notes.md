...
* to quickly showcase some of the student work coming out of the program ... 
  ...
  * example
  * example
* web mapping and the curriculum it's intended to support is technically demanding and challenging, particularly as students have little background in web design and coding
* beyond these challenging aspects, the courses are taught asynchronously and completely online to a geographically distributed student body
